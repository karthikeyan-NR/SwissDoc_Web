...
const routes: Routes = [
    {
        ...
        children: [
            ...
            { path: 'profile', loadChildren: () => import('./components/user-details/user-details.module').then(m => m.UserDetailsModule) },
            { path: 'view-chart/:id', loadChildren: () => import('./components/view-chart/view-chart.module').then(m => m.ViewChartModule) }
        ]
    },
